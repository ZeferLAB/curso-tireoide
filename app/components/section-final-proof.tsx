        ...
        <section className="bg-white py-20 lg:py-24 font-['Poppins'] border-t border-slate-100">
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    {[
                        {
                            text: "Profe.. eu aprendi e continuo aprendendo muito com vc, vc é excepcional, sempre respondendo minhas duvidas. Sua generosidade com os alunos em passar toda a sua bagagem de conhecimentos não tem preço, só uma pessoa que o que faz tem esa dedicação. Muito obrigada por me guiar sempre. ❤️",
                            author: "Aluno do Curso"
                        },
                        {
                            text: "O diferencial do curso de ultrassonografia da Dra Cláudia é a sua grande experiência técnica e de conhecimentos de casos na área de ultrassonografia, onde aprendi muito, e contribuiu com minha formação, e sempre nos orientando, tirando dúvidas. Sempre agradeço por ter essa excelente profissional e amiga que nos dá o suporte em inúmeros casos, onde discutimos os exames e aprendemos cada vez mais",
                            author: "Aluno do Curso"
                        },
                        {
                            text: "O curso de ultrassom ministrado pela Dra. Claudia Chagas que realizei foi de grande aproveitamento e profissionalismo depois dele além de pegar usg realizados por terceiros em atendimentos médicos não vou direto ao laudo agora vou direto para as imagens pois sei interpretar o que estou vendo se está medido corretamente ou se algo de importante não aparece no laudo. Além de saber manusear um aparelho de Ultrassom, após esse curso minha qualidade e segurança profissional melhorou muito",
                            author: "Aluno do Curso"
                        }
                    ].map((item, index) => (
                        <div key={index} className="relative rounded-2xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:-translate-y-2 transition-all duration-300 border border-slate-200 bg-slate-50 group p-6 flex flex-col justify-between">
                            {/* Content */}
